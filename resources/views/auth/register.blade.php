                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('register-post') }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="name" class="form-control" id="yourName"  placeholder="please enter your name"
                                                required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="email" name="email" class="form-control" id="yourEmail" placeholder="please enter your email"
                                                required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" name="phone" class="form-control"
                                                    id="yourPhone" maxlength="15" placeholder="please enter your phone number" required>
                                                <div class="invalid-feedback">Please choose a user phone number </div>
                                            </div>
                                        </div>
